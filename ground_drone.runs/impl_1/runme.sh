...
HD_PWD='C:/Users/fer99/Documents/02. MAE2/433 - Architecture Design and Synthesis of Hardware Systems/ground_drone/ground_drone.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Drone.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Drone.tcl -notrace
