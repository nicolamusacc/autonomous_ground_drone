...
HD_PWD='C:/Users/fer99/Documents/02. MAE2/433 - Architecture Design and Synthesis of Hardware Systems/ground_drone/ground_drone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Drone.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Drone.tcl
